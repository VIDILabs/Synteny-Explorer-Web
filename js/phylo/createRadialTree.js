    ...
    var node = chart.selectAll(".node")
                    ...
                    .on("click", function(d) {
                        if (selected == 0) {
                            ...
                            $("#speOne").html("<div class=\"boxTitle\"><img src=png/" + d.data.name + "_sm.png style=\"width:60px;height:60px;\"><p class=\"textTitle\" style=\"font-size:0.9rem\">" + sName[d.data.name] + "</p><p class=\"textArea\">" + wiki[d.data.name] + "</p><div>");
                            ...
                            if(firstNode == secondNode){
                                ...
                                $("#speTwo").html("<div class=\"boxTitle\"><img src=png/" + d.data.name + "_sm.png style=\"width:60px;height:60px;\"><p class=\"textTitle\" style=\"font-size:0.9rem\">"+ sName[d.data.name] + "</p><p class=\"textArea\">" + wiki[d.data.name] + "</p><div>");
